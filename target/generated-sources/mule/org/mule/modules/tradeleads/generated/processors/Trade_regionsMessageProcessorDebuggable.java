...
public class Trade_regionsMessageProcessorDebuggable
    extends Trade_regionsMessageProcessor
    implements DebugInfoProvider
{


    public Trade_regionsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("trade_regions", "Trade_regions", (java.lang.String.class), trade_regions, muleEvent));
