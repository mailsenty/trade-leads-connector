...
public class World_regionsMessageProcessorDebuggable
    extends World_regionsMessageProcessor
    implements DebugInfoProvider
{


    public World_regionsMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("world_regions", "World_regions", (java.lang.String.class), world_regions, muleEvent));
